...
public class VMnoWhiteSpace {

	/*Just a minor change from the previous verison of whitespace remover.
	 * This one doesn't remove whitespaces (misleading, yes) and only removes
	 * comments, both multi line and single line.
	 */
